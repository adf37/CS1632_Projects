...
public class MainPanel extends JPanel {
	...
	//Another modification, checks too many branches
	...
	_running = true;
	int count = 0; //keep the count of how many iterations are completed and limiting to 1000 total iterations. We do this to properly time modifications.
	while (_running && count <1000) {
		count++;
